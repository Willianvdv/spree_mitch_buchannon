...
describe Spree::Mitch do
  ...
  context 'motivational emails' do
    ...
    describe '.orders_that_need_motivation' do
      subject { described_class.new.orders_that_need_motivation }
  ...
  describe '.send_payment_reminder_emails_to_unpaid_orders' do
    ...
    before :each do
      subject.stub(:payment_reminder_candidates).and_return [order,]
    ...
    it 'sends the payment_reminder_email to all payment reminder candiates' do
      ...
      subject.send_payment_reminder_emails_to_unpaid_orders
    end
  end
  ...
  describe '#cancellation_candidates' do
    ...
    subject { described_class.new.cancellation_candidates }
  ...
  describe '#payment_reminder_candidates' do
    subject { described_class.new.payment_reminder_candidates }
